...
class HasilQuizFlutter extends StatefulWidget {
  final int score;
  const HasilQuizFlutter(this.score, {super.key});

  @override
  State<HasilQuizFlutter> createState() => _HasilQuizFlutterState();
}

class _HasilQuizFlutterState extends State<HasilQuizFlutter> {
  @override
